...
{
	class ArcherStateClass : public GameState::CGameState
	{
	public:
		UserPlayer::Player* Class;
		int ClassType;
		ArcherStateClass(UserPlayer::Player* Class, int ClassType)
		{
			this->Class = Class;
